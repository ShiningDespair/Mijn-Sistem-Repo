            ...
            <div className="col-md-2 col-sm-6">
              <div className="footer-menu">
                ...
                <ul className="menu-list list-unstyled">
                  ...
                  <li className="menu-item">
                    <a href="#" className="nav-link">Sıkça Sorulan Sorular </a>
                  </li>
                  <li className="menu-item">
                    <a href="#" className="nav-link">Banka Hesaplarımız</a>
                  </li>
                  <li className="menu-item">
                    <a href="#" className="nav-link">Sipariş Takibi</a>
                  </li>
                  <li className="menu-item">
            ...
            <div className="col-md-2 col-sm-6">
              <div className="footer-menu">
                ...
                <ul className="menu-list list-unstyled">
                  ...
                  <li className="menu-item">
                    <a href="#" className="nav-link">Gizlilik ve Kvkk Bilgileri</a>
                  </li>
                  <li className="menu-item">
                    <a href="#" className="nav-link">Kargo ve Teslimat Bilgileri</a>
                  </li>
                  <li className="menu-item">
                    <a href="#" className="nav-link">İptal ve İade Koşulları</a>
                  </li>
                  <li className="menu-item">
                    <a href="#" className="nav-link">Mesafeli Satış Sözleşmesi</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-md-2 col-sm-6">
              <div className="footer-menu">
                ...
                <ul className="menu-list list-unstyled">
                  ...
                  <li className="menu-item">
                    <a href="#" className="nav-link">Yeni Ürünler</a>
                  </li>
                  <li className="menu-item">
                    <a href="#" className="nav-link">İndirimdeki Ürünler</a>
                  </li>
                  <li className="menu-item">
                    <a href="#" className="nav-link">Sipariş Takibi</a>
                  </li>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="footer-menu">
                ...
                <form className="d-flex mt-3 gap-0" role="newsletter">
                  <input className="form-control rounded-start rounded-0 bg-light" type="email" placeholder="Email Adresi" aria-label="Email Addresi" />
                  <button className="btn btn-dark rounded-end rounded-0" type="submit">Takip Et.</button>
                </form>
              </div>
            </div>
